...
import { Box, Paper, Typography, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Button, TextField, Grid, Chip, Dialog, DialogTitle, DialogContent, DialogActions, IconButton, Alert, useTheme, useMediaQuery, InputAdornment, TablePagination } from '@mui/material';
						...
						>
							...
							<TableBody>
								{filteredRefunds.slice(page * 10, page * 10 + 10).map(s => (
									<TableRow key={s._id} id={`refund-${s._id}`}>
										<TableCell sx={{
											...cellSx,
											position: 'sticky',
											left: 0,
